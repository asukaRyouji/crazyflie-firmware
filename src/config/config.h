...
#define AIRFLOWDECK_TASK_PRI    4
#define POTPITCHDECK_TASK_PRI   2
...
#define AIRFLOWDECK_TASK_NAME   "AIRFLOWDECK"
#define POTPITCHDECK_TASK_NAME   "POTPITCHDECK"
...
#define AIRFLOWDECK_TASK_STACKSIZE    (2 * configMINIMAL_STACK_SIZE)
#define POTPITCHDECK_TASK_STACKSIZE    (2 * configMINIMAL_STACK_SIZE)
